...
class WebServices_DROVET {
	...
	function __construct() {
		$this->soap = new soapClient(
			'https://www.projectsconsulting.com.ar:7443/yavuws/token',
			array(
				//'soap_version' 			=> SOAP_1_1,
				//'location'     			=> 'https://www.projectsconsulting.com.ar:7443/yavuws/token',
				'grant_type'			=> 'password',
				'client_secret'			=> 'oauth2clientsecret',
				'client_id'				=> 'drovetMobile',
				'username'				=> 'yavuws',
				'password'				=> 'Y4vuwS',
				//'exceptions'	   		=> true,
	 ...
	 * return bool
	 */
	public function AutenticarUsuario($pUsername = 'yavuws', $pPassword = 'Y4vuwS', $pCompany = 1, $pWebWervice = 1000) {
