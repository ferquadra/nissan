 ...
 * @subpackage 	Libraries
 * @author Gabriel Luraschi
 * @uses DbDriver_Ibase, DbDriver_MsSql, DbDriver_MySql, DbDriver_SqlSrv, IDbDriver
 */
class Dbconnection {
	...
	private function _factory($cDriverName, $cHost, $cUser, $cPass, $cDbName) {
		// Si es un driver soportado por ClassLib lo carga.
		switch ($cDriverName) {
			case 'Ibase':
				require_once(APP_SYSTEM_PATH."/database/DbDriver_Ibase.php");
				return DbDriver_Ibase::_getInstance($cHost, $cUser, $cPass, $cDbName);
				break;
				
			case 'x-MsSql':
				require_once(APP_SYSTEM_PATH."/database/DbDriver_MsSql.php");
				return DbDriver_MsSql::_getInstance($cHost, $cUser, $cPass, $cDbName);
				break;
				
			case 'MySql':
				require_once(APP_SYSTEM_PATH."/database/DbDriver_MySql.php");
				return DbDriver_MySql::_getInstance($cHost, $cUser, $cPass, $cDbName);
				break;
				
			case 'x-SqlSrv':
				require_once(APP_SYSTEM_PATH."/database/DbDriver_SqlSrv.php");
				return DbDriver_SqlSrv::_getInstance($cHost, $cUser, $cPass, $cDbName);
				break;
